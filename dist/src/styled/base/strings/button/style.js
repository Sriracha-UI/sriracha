...
import { buttonColor, buttonBackground, buttonHoverColor, buttonHoverBackground, buttonCursorStyle, boxShadow, hoverShadow, activeBackground, } from "../../../maps";
export default css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  color: ", ";\n  background: ", ";\n  border: ", ";\n  border-style: ", ";\n  border-width: ", ";\n  border-radius: ", ";\n  border-color: ", ";\n  opacity: ", ";\n  box-shadow: ", ";\n\n  transition: color 0.5s, background 0.5s, box-shadow 0.5s;\n\n  &:hover {\n    color: ", ";\n    background: ", ";\n    border: ", ";\n    border-style: ", ";\n    border-width: ", ";\n    border-color: ", ";\n    box-shadow: ", ";\n    cursor: ", ";\n  }\n\n  &:active {\n    background: ", ";\n  }\n\n  &[disabled] {\n    opacity: 0.2;\n    cursor: not-allowed;\n  }\n"], ["\n  color: ",
    ...
    return props.theme.shadows[props.hvrShadow]
        ...
        : props.hvrShadow
            ? props.hvrShadow
            : hoverShadow;
}, buttonCursorStyle, function (props) {
    return props.activeBg ? props.activeBg : activeBackground;
});
