...
export const darkColors = {
  ...
  whiteAlpha0: "rgba(0, 0, 0, 0.04)",
  whiteAlpha1: "rgba(0, 0, 0, 0.06)",
  whiteAlpha2: "rgba(0, 0, 0, 0.08)",
  whiteAlpha3: "rgba(0, 0, 0, 0.16)",
  whiteAlpha4: "rgba(0, 0, 0, 0.24)",
  whiteAlpha5: "rgba(0, 0, 0, 0.36)",
  whiteAlpha6: "rgba(0, 0, 0, 0.48)",
  whiteAlpha7: "rgba(0, 0, 0, 0.64)",
  whiteAlpha8: "rgba(0, 0, 0, 0.80)",
  whiteAlpha9: "rgba(0, 0, 0, 0.92)",

  blackAlpha0: "rgba(255, 255, 255, 0.04)",
  blackAlpha1: "rgba(255, 255, 255, 0.06)",
  blackAlpha2: "rgba(255, 255, 255, 0.08)",
  blackAlpha3: "rgba(255, 255, 255, 0.16)",
  blackAlpha4: "rgba(255, 255, 255, 0.24)",
  blackAlpha5: "rgba(255, 255, 255, 0.36)",
  blackAlpha6: "rgba(255, 255, 255, 0.48)",
  blackAlpha7: "rgba(255, 255, 255, 0.64)",
  blackAlpha8: "rgba(255, 255, 255, 0.80)",
  blackAlpha9: "rgba(255, 255, 255, 0.92)",
